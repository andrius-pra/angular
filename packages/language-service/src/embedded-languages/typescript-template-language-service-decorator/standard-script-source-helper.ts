...
export default class StandardScriptSourceHelper implements ScriptSourceHelper {
  constructor(private readonly typescript: typeof ts, private readonly project: ts.server.Project) {
  }
  ...
  private getProgram() { return this.project.getLanguageService().getProgram(); }
